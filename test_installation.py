...
def main():
    ...
    if passed == total:
        ...
        print("2. Run: python -c \"from video_transcription import VideoTranscriptionPipeline; pipeline = VideoTranscriptionPipeline(); result = pipeline.transcribe('your_video.mp4', 'output/')\"")
    else:
        print("\n⚠️ Some tests failed. Please address the issues above.")
        print("\nFor help:")
        print("- Check the documentation: https://github.com/yourusername/video-transcription-pro")
        print("- Open an issue: https://github.com/yourusername/video-transcription-pro/issues")
