...
class TranscriptFormatter:
    ...
    def _format_detailed(self, segments: List[Dict], include_timestamps: bool, result: Dict) -> str:
    ...
    def _format_timestamp(self, start_time: float, end_time: Optional[float] = None) -> str:
    ...
    def save_srt(self, 
                 result: Dict, 
                 output_path: Union[str, Path],
                 speaker_names: Optional[Dict] = None) -> str:
        """
