...
class TestVideoTranscriptionPipeline:
    ...
    def test_init(self):
        ...
        pipeline = VideoTranscriptionPipeline(
            whisper_model="medium", device="cpu", num_speakers=2
        )
    ...
    def test_process_audio_generates_outputs(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            pipeline.transcriber, "transcribe", lambda path: fake_whisper
        )
...
class TestBatchProcessor:
    ...
    def test_init(self):
        ...
        processor = BatchProcessor(
            whisper_model="medium", max_workers=2, output_formats=["txt", "json"]
        )
